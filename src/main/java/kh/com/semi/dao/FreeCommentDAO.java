...
import kh.com.semi.dto.FreeCommentDTO;
...
public class FreeCommentDAO {
	...
	// 댓글 목록 긁어오기
	public ArrayList<FreeCommentDTO> getCommentList(int board_seq) {
		...
		try (Connection con = this.getConnection(); PreparedStatement pstmt = con.prepareStatement(sql);) {
			...
			while (rs.next()) {
				...
				list.add(new FreeCommentDTO(comment_seq, writer_nickname, comment_content, written_date, board_seq,
						writer_id));
			}
			return list;
		} catch (Exception e) {
