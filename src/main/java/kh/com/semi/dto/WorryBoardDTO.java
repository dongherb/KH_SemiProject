...
public class WorryBoardDTO {
	public WorryBoardDTO() {
	}
	...
	private String board_category = "고민";
	private String id;

	public WorryBoardDTO(int board_seq, String writer_nickname, String board_title, String board_content,
			Date written_date, int view_count, int recommended_count, String board_category, String id) {
		super();
