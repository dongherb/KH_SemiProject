...
public class ExerciseBoardService {
	private ExerciseBoardDAO dao = new ExerciseBoardDAO();
	...
	public ArrayList<ExerciseBoardDTO> getBoardList(int currentPage){
		int startRange = currentPage * recordCntPerpage - (recordCntPerpage-1);
		int endRange = currentPage * recordCntPerpage;
		
		ArrayList<ExerciseBoardDTO> list = dao.getBoardList(startRange,endRange);
		return list;
	}
