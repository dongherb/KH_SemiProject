...
<body>
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item">
					<img src="../images/sub_navi06.png" class="d-block w-100"
						alt="...">
					<div class="carousel-caption d-none d-md-block">
						<h1 class="display-4 main_copy3 text_gradation ">운동센터의 가성비, 가심비!</h1>
					</div>
				</div>
			</div>
	...
	<div class="container ">
		...
		<form id="businessSignupForm" name="businessSignupForm"
			...
			<div class="row p-2">
				...
				<div class="col-4 mb-2 sm-1">
					<input type="text" maxlength="10" class="form-control" id="business_no" name="business_no" readonly>
					<div class="idNotice">※사업자등록번호는 반드시 숫자 10자리만 등록가능합니다.</div>
				</div>
				<div class="col-2 mb-2 sm-1">
					<button type="button" id="btnCheckBn" class="btn btn-warning w-100">사업자등록번호 확인</button>
				</div>
			</div>
	...
	function setCenter_profile(event) { 
		...
		let btnCheckBn = document.getElementById("btnCheckBn");
		...
		//사업자번호 확인버튼
		btnCheckBn.addEventListener("click", function() {
			let url = "/bnCheckPopup.mem";
			let name = "사업자번호 중복검사";
			let option = "width=600, height=600, top=300, left=650";
			window.open(url, name, option);
		});
