...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col">
				<h1 class="font_nanum center">휘 핑</h1>
				<br> <br>
			</div>
		</div>
		<div class="row">
			<div class="col">
				<h1 class="font_nanum center">회 원 가 입</h1>
				<br> <br>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col center">
					<button type="button" class="btn btn-warning font_nanum"
						id="btnGeneral">일반회원 가입</button>
					<p></p>
					<p>
						일반회원은 플랫폼을 사용하는<br> 일반인을 말합니다.
					</p>
				</div>
				<div class="col center">
					<button type="button" class="btn btn-warning font_nanum"
						id="btnBusiness">사업자회원 가입</button>
					<p></p>
					<p>
						사업자회원은 운동센터 사업장을 운영중인<br> 사장님, 운영자를 말합니다.
					</p>
				</div>
				<div class="col"></div>
			</div>
